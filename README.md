...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/trevorlauder/cloudflare-doh-worker/tree/deploy-1.0.0-rc7)
...
- Fork this repo on GitHub, then clone your fork and reset `main` to the latest deploy tag:
  ...
  git checkout -B main deploy-1.0.0-rc7
